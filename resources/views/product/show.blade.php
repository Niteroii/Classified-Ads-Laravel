    ...
    <div class="carousel-item">
      <img src="{{ Storage::url($advertisement->second_image) }}" class="d-block w-100" alt="...">
            ...
            <div class="col-md-6">
                ...
                <p>Price: KSH{{ $advertisement->price }} , {{ $advertisement->price_status }}</p>
                ...
                <p>
                    ...
                    <span>
                        ...
                        @endif
                        <a href="" data-toggle="modal" data-target="#exampleModal"class="badge rounded-pill bg-danger" >
                           
                            <i class="fa-solid fa-flag">Report this ad</i>
